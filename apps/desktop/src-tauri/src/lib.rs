...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            plugins::save_custom_tool,
            plugins::delete_custom_tool,
            plugins::test_custom_tool,
            plugins::save_local_skill,
            plugins::save_visual_skill,
            plugins::list_visual_skills,
            plugins::delete_visual_skill,

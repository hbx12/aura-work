...
- **Comment Reply**: Replies when `@aura-bot` is mentioned or a clear question is asked and no maintainer has replied.
...
3. **Anti-spam**: The bot replies at most once per item unless mentioned again. It never replies to itself.
